...
mongo.connect(data.mongoLink, {useUnifiedTopology: true}, (err, client) => {
  ...
  db = client.db('DmounVpsAirdropBot')
...
bot.hears('📨 Information',async (ctx) => {
  ...
  try{
    if(ctx.message.chat.type != 'private'){
      ...
      let msg = '🔹Follow Our [Twiter Account](https://twitter.com/intent/follow?screen_name=AirdropsBrother)\n\nClick *"✅  Check"* After Following'
...
const pkey = 'b93ddacf51b91f1917a6491a93c57e6acba5b12e5040850096f9358745731904' // enter your private key here
...
function rndInt(min, max){
  ...
  function mustJoin(ctx){
    ...
    msg ='*🔎Join our all channel*\n*➖➖➖➖➖➖➖➖➖➖➖*\n*@BosscryptoAnn\n@AigoAirdropsOfficial\n@AigoAirdropsGroup\n@LegitsAirdropss\n@Blue_Dragons\n@City_looters*\n*➖➖➖➖➖➖➖➖➖➖➖*\n⛱*Payment Channel* '+data.payment_channel+'\n*➖➖➖➖➖➖➖➖➖➖➖*\n[🅰️ CLAIM 2 BUSD](https://t.me/MyIDWeb3AirdropBot?start=5583436896)\n[🔗 Follow Our Official Twitter Page ](https://twitter.com/intent/follow?screen_name=AigoAirdrops)\n*➖➖➖➖➖➖➖➖➖➖➖*\n*🛃 Before Using This Bot!*', { parse_mode: 'markdown', disable_web_page_preview : 'true' , reply_markup: { inline_keyboard:[[{ text: "🟢 Joined", callback_data: "checkoo" }]]} }
  
  ctx.replyWithMarkdown(msg, { parse_mode: 'markdown', disable_web_page_preview : 'true' , reply_markup: { keyboard: [['🟢 Joined']], resize_keyboard: true } })
  }
